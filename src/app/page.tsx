...
import NeonTransferButton from './components/NeonTransferButton';
import CoinbaseAIButton from './components/CoinbaseAIButton';
  ...
  return (
    <Box sx={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }}>
      ...
      >
        ...
        {/* Collection Message and Buttons */}
        {!isSearching && !results.length && (
          <Box sx={{ textAlign: 'center', mt: 4 }}>
            <Typography variant="h6" className={handjet.className} sx={{ color: 'white', fontSize: '12px', height: '12px' }}>
              Engine for 10M+ Free 3D assets from:
            </Typography>
            <Box sx={{ mt: 2, display: 'flex', gap: 2, justifyContent: 'center' }}>
              <Button
                variant="contained"
                className={handjet.className}
                sx={{ backgroundColor: '#24292E', color: 'white' , fontSize: '10px' }}
              ...
              <Button
                variant="contained"
                className={handjet.className}
                sx={{ backgroundColor: '#FF3E00', color: 'white' , fontSize: '10px' }}
              ...
              <Button
                variant="contained"
                className={handjet.className}
                sx={{ backgroundColor: '#1CAAD9', color: 'white', fontSize: '10px' }}
              ...
              <Button
                variant="contained"
                className={handjet.className}
                sx={{ backgroundColor: '#4285F4', color: 'white' , fontSize: '10px' }}
            ...
            >
              ...
              <CardContent sx={{ flexGrow: 1 }}>
                <Typography variant="h6" gutterBottom>
                  {truncateDescription(result?.name, 4)}
                </Typography>
                <Typography variant="body2" sx={{ color: '#aaaaaa', mb: 2 }}>
                  {truncateDescription(result?.description || "No description available.", 3)} {/* Truncate to 10 words */}
                </Typography>
